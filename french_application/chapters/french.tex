...
\bottomrule
\end{tabular}
\caption{Macro F1 sur la classification CIM-10 multi-étiquettes (données françaises AP-HP, \num{20000} documents). Le gain relatif est calculé par rapport à Step0 (ajustement supervisé seul, sans DPO).}
