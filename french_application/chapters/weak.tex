...
\begin{tabular}{lccc}
\toprule
\textbf{Langue} & \textbf{Modèle} & \textbf{F1 (dict)} & \textbf{F1 (LLM)} \\
\midrule
Anglais  & Bio\_ClinicalBERT     & \textbf{0,68} & 0,66 \\
Espagnol & BSC-LT biomedical-es  & \textbf{0,78} & 0,72 \\
Français & CamemBERT             & 0,69 & \textbf{0,75} \\
Italien  & dbmdz                 & 0,73 & \textbf{0,74} \\
Basque   & berteus               & 0,54 & \textbf{0,60} \\
\bottomrule
\end{tabular}
\caption{F1 sur le jeu de test \emph{gold} E3C par langue et meilleur modèle encodeur. « Dict » ($r_{\text{mix}} = 0$) : supervision par dictionnaire UMLS seul ; « LLM » ($r_{\text{mix}} = 1$) : supervision par InstructGPT seul.}
...
En basque, le lexique UMLS est extrêmement pauvre : sur le corpus d'entraînement, le dictionnaire n'extrait que \num{63} tokens I\_clin, contre \num{482} pour InstructGPT.
