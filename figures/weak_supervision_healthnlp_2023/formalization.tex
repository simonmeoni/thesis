...
\caption{Illustration of our method's prediction and structuring steps on an example. The $t$ template is illustrated in Figure \ref{fig:formalization}. See glossary for translated example}
