...
\caption{F1-score, Recall and Precision using E3C \Sval as the train set with both models (\weakModel and \distilmodels). Performance is computed on \Sgold.}
\label{tab:healthnlp_layer2validate}
\end{table}
