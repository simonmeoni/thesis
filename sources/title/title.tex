...
\begin{titlepage}
	...
	\begin{center}
		...
		\vspace{0.cm}
		\normalsize Présentée et soutenue publiquement le XX Juin 2026 devant le jury composé de :\\
		\vspace{0.2cm}
		\begin{tabular*}{0.9\linewidth}{l c r}
			Xavier \textsc{Tannier} & Sorbonne Université & Rapporteur \\
			Pierre \textsc{Zweigenbaum} & Laboratoire Interdisciplinaire des Sciences du Numérique & Rapporteur \\
			XXXXXX \textsc{XXXXXX} & XXXXXXXXX XXXXXXXXX & Examinateur \\
			XXXXXX \textsc{XXXXXX} & XXXXXXXXX XXXXXXXXX & Examinateur \\
