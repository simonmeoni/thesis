...
\begin{titlepage}
	...
	\begin{center}
		...
		\Large \textbf{Éric \textsc{De la Clergerie}} et \textbf{Théo \textsc{Ryffel}}\\
		\vspace{0.4cm}
		...
		{\Large  \textbf{On Creating Clinical Synthetic Data}}\\[0.1cm]

		\hrulefill\\

		\vspace{0.cm}
		\normalsize Présentée et soutenue publiquement le 1 décembre 2025 devant le jury composé de :\\
		\vspace{0.4cm}
