...
Table \ref{tab:appendix_setting_c} presents results for \Sstar, using \hybridmodel approach that combines \Ssilver annotations with manually corrected \Sval data.
