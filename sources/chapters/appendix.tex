...
This appendix documents the technical configuration used to integrate generative AI assistance into the thesis writing workflow.
...
\begin{enumerate}
    ...
    \item \textbf{Critical review}: All AI suggestions were reviewed and edited before inclusion.
...
Commit messages include co-authorship attribution (\texttt{Co-Authored-By: Claude}) when AI assistance was used for the changes.
